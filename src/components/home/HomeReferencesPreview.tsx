...
export default function HomeReferencesPreview() {
  return (
    <section className="py-20 lg:py-28 bg-bg" aria-label="Aperçu références">
        ...
        <FadeIn className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight">
              Des transformations{" "}
              <span className="text-primary-light">qui durent.</span>
            </h2>
          </div>
          <Link
            href="/references"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {references.map((r, i) => (
            <FadeIn
              ...
              delay={i * 100}
              as="article"
              className={`${r.color} rounded-2xl p-7 text-white flex flex-col min-h-[280px]`}
            >
