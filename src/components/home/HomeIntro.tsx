...
export default function HomeIntro() {
  return (
    <section className="py-20 lg:py-28 bg-bg" aria-label="Présentation">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          <FadeIn className="lg:col-span-5">
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight">
              ...
              <span className="text-primary-light">trajectoires claires.</span>
            </h2>
          </FadeIn>

          <FadeIn delay={120} className="lg:col-span-7 space-y-5 text-text-light text-base lg:text-lg leading-relaxed">
            <p>
